    ...
    <div className="icon-demo-container">
      <m.img
        ...
        animate={{
          ...
          translateX: [
            0, 1, 2, 3, 4, 5, 5.5, 5, 4, 2.5, 0, -2.5, -4, -5, -5.5, -5, -4, -3, -2, -1, 0,
          ],
          rotate: [
            0, -1.5, -2.5, -3, -3.5, -4, -3.5, -2.5, -1.5, -0.5, 0, 0.5, 1.5, 2.5, 3.5, 4, 3.5, 3,
            2.5, 1.5, 0,
          ],
          scale: [
            1, 1.002, 1.004, 1.006, 1.008, 1.01, 1.012, 1.014, 1.016, 1.018, 1.02, 1.018, 1.016,
