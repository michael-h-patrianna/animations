...
function ModalHeader({ titleId, title, headerRight, onClose }: {
  titleId: string
  title: string
  headerRight?: React.ReactNode
  onClose: () => void
  ...
  return (
    <div className='flex items-center justify-between px-4 py-3 border-b border-panel-border bg-panel-header/50'>
      ...
      <div className='flex items-center gap-2'>
        {headerRight}
        <Button data-testid='demo-modal-close' variant='ghost' size='icon' onClick={onClose} ariaLabel='Close modal' className='p-1'>
...
export const Modal: React.FC<ModalProps> = ({
  isOpen, onClose, title, children, headerRight, width = 'max-w-md',
