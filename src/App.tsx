...
/**
 * Root application component. Wires together sidebar navigation, animation catalog,
 * and mobile drawer. Navigation state and keyboard shortcuts are managed via custom hooks.
 */
function App() {
