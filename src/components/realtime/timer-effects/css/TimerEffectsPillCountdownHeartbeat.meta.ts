...
export const metadata: AnimationMetadata = {
  ...
  urlSlugFramer: '/timer-effects-framer?animation=timer-effects__pill-countdown-heartbeat',
  urlSlugCss: '/timer-effects-css?animation=timer-effects__pill-countdown-heartbeat',
