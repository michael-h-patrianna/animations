 ...
 *
 * Copy-paste files: this file + TimerEffectsPillCountdownGlitch.module.css + ./shared.css + ../SharedTypes.ts + ../SharedTimer.ts + ../SharedFormat.ts + ../SharedPillPhaseTheme.ts
 * Runtime deps: react
 */
