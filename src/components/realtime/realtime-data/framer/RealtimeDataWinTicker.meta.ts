...
export const metadata = {
  ...
  tier: 4,
  props: [
    { type: 'string', name: 'items', label: 'Items', disabled: true, disabledReason: 'string[] — set via code' },
    { type: 'string', name: 'separator', label: 'Separator', default: ' · ' },
    { type: 'number', name: 'duration', label: 'Duration', default: 8000, min: 2000, max: 20000, step: 500, unit: 'ms' },
