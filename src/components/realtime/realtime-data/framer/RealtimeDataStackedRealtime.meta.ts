...
export const metadata = {
  ...
  tier: 3,
  props: [
    { type: 'string', name: 'items', label: 'Items', disabled: true, disabledReason: 'StatEntry[] — set via code' },
    { type: 'number', name: 'staggerDelay', label: 'Stagger Delay', default: 80, min: 20, max: 300, step: 10, unit: 'ms' },
    { type: 'number', name: 'duration', label: 'Duration', default: 600, min: 200, max: 2000, step: 100, unit: 'ms' },
    { type: 'color', name: 'activeColor', label: 'Active Color', default: 'var(--pf-anim-cyan)' },
    { type: 'color', name: 'inactiveColor', label: 'Inactive Color', default: 'var(--pf-anim-gray-400)' },
  ],
