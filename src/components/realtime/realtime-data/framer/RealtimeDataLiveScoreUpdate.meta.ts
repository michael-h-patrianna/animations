...
export const metadata = {
  ...
  props: [
    ...
    { type: 'number', name: 'increment', label: 'Increment', default: 120, min: 10, max: 1000, step: 10 },
    { type: 'number', name: 'duration', label: 'Duration', default: 800, min: 200, max: 3000, step: 100, unit: 'ms' },
    { type: 'color', name: 'highlightColor', label: 'Highlight Color', default: 'var(--pf-anim-green)' },
