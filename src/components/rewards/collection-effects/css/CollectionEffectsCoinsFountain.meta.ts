...
export const metadata = {
  ...
  demoMode: 'fountain',
  props: [
    { type: 'number', name: 'count', label: 'Particle Count', default: 12, min: 1, max: 40, step: 1 },
    { type: 'number', name: 'particleSize', label: 'Particle Size', default: 24, min: 8, max: 80, step: 2, unit: 'px' },
    { type: 'number', name: 'spread', label: 'Eruption Height', default: 160, min: 30, max: 300, step: 10, unit: 'px' },
