...
export const metadata = {
  ...
  demoMode: 'magnet',
  props: [
    { type: 'number', name: 'count', label: 'Particle Count', default: 10, min: 1, max: 40, step: 1 },
    { type: 'number', name: 'particleSize', label: 'Particle Size', default: 24, min: 8, max: 80, step: 2, unit: 'px' },
    { type: 'number', name: 'spread', label: 'Emit Distance', default: 60, min: 10, max: 200, step: 10, unit: 'px' },
    { type: 'number', name: 'duration', label: 'Duration', default: 2000, min: 300, max: 5000, step: 100, unit: 'ms' },
    ...
    { type: 'string', name: 'from', label: 'From Point', disabled: true, disabledReason: 'Ref or {x,y} — set in code' },
    { type: 'string', name: 'to', label: 'To Point', disabled: true, disabledReason: 'Ref or {x,y} — set in code' },
