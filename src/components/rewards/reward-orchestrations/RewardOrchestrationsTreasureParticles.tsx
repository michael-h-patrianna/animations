...
export function RewardOrchestrationsTreasureParticles() {
  ...
  return (
    <div className="pf-reward-orchestration pf-reward-orchestration--treasure-particles" ref={containerRef}>
