...
export function RewardOrchestrationsMultiCoin() {
  ...
  return (
    <div className="pf-reward-orchestration pf-reward-orchestration--multi-coin" ref={containerRef}>
