...
registerLazyCategory('rewards', 'Game Elements & Rewards', [
  {
    id: 'collection-effects-framer',
    title: 'Collection Effects (Framer)',
    tech: 'framer',
    baseGroupId: 'collection-effects',
    animationIds: [],
    metadata: collectionEffectsMeta,
  },
  {
    id: 'collection-effects-css',
    title: 'Collection Effects (CSS)',
    tech: 'css',
    baseGroupId: 'collection-effects',
    animationIds: [],
    metadata: collectionEffectsMeta,
  },
  {
    ...
    title: 'Icon Animations (Framer)',
    tech: 'framer',
    baseGroupId: 'icon-animations',
    animationIds: [],
    metadata: iconAnimationsMeta,
  },
  {
    id: 'icon-animations-css',
    title: 'Icon Animations (CSS)',
    tech: 'css',
    baseGroupId: 'icon-animations',
    animationIds: [],
    metadata: iconAnimationsMeta,
  ...
  {
    id: 'modal-celebrations-framer',
    title: 'Modal Celebrations (Framer)',
    tech: 'framer',
    baseGroupId: 'modal-celebrations',
    animationIds: [],
    metadata: modalCelebrationsMeta,
  },
  {
    id: 'modal-celebrations-css',
    title: 'Modal Celebrations (CSS)',
    tech: 'css',
    baseGroupId: 'modal-celebrations',
    animationIds: [],
    metadata: modalCelebrationsMeta,
  ...
  {
    id: 'prize-reveal-framer',
    title: 'Prize Reveal (Framer)',
    tech: 'framer',
    baseGroupId: 'prize-reveal',
    animationIds: [],
    metadata: prizeRevealMeta,
  },
  {
    id: 'prize-reveal-css',
    title: 'Prize Reveal (CSS)',
    tech: 'css',
    baseGroupId: 'prize-reveal',
    animationIds: [],
    metadata: prizeRevealMeta,
