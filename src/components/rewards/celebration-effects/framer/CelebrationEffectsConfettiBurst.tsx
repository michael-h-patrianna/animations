...
import './CelebrationEffectsConfettiBurst.module.css'
...
interface CelebrationEffectsConfettiBurstProps extends CelebrationBaseProps {
...
function CelebrationEffectsConfettiBurstComponent({
  ...
  duration,
  onComplete,
}: CelebrationEffectsConfettiBurstProps) {
  ...
  if (prefersReducedMotion) {
    return (
      <div
        ...
        data-animation-id="celebration-effects__confetti-burst"
      />
    )
  }
...
export const CelebrationEffectsConfettiBurst = memo(CelebrationEffectsConfettiBurstComponent)
