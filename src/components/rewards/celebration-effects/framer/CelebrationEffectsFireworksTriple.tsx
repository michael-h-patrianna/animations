...
import './CelebrationEffectsFireworksTriple.module.css'
...
type CelebrationEffectsFireworksTripleProps = CelebrationBaseProps
...
function CelebrationEffectsFireworksTripleComponent({
  particleImages = [],
  particleMaxWidth = 24,
  particleMaxHeight = 24,
  onComplete,
}: CelebrationEffectsFireworksTripleProps) {
  ...
  if (prefersReducedMotion)
    return (
      <div className="pf-celebration" data-animation-id="celebration-effects__fireworks-triple" />
    )
...
export const CelebrationEffectsFireworksTriple = memo(CelebrationEffectsFireworksTripleComponent)
