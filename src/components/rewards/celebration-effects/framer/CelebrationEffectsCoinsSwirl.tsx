...
import './CelebrationEffectsCoinsSwirl.module.css'
...
function CelebrationEffectsCoinsSwirlComponent({
  ...
  if (prefersReducedMotion)
    return <div className="pf-celebration" data-animation-id="celebration-effects__coins-swirl" />

  return (
    <div className="pf-celebration" data-animation-id="celebration-effects__coins-swirl">
