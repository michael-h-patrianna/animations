...
import './CelebrationEffectsCoinCascade.module.css'
...
import { GOLDEN_COLORS } from '@/components/rewards/celebration-effects/utils'
...
interface CelebrationEffectsCoinCascadeProps extends CelebrationBaseProps {
...
function CelebrationEffectsCoinCascadeComponent({
  ...
  boundary,
  onComplete,
}: CelebrationEffectsCoinCascadeProps) {
  ...
  if (prefersReducedMotion) {
    return <div className="pf-celebration" data-animation-id="celebration-effects__coin-cascade" />
  }
  ...
  return (
    <div
      ...
      data-animation-id="celebration-effects__coin-cascade"
    >
      {STREAMS.map((x, i) => (
        <SourceGlow
          key={i}
...
export const CelebrationEffectsCoinCascade = memo(CelebrationEffectsCoinCascadeComponent)
