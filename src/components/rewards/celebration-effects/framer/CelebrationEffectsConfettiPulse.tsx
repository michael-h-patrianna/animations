...
import './CelebrationEffectsConfettiPulse.module.css'
...
interface CelebrationEffectsConfettiPulseProps extends CelebrationBaseProps {
...
function CelebrationEffectsConfettiPulseComponent({
  ...
  duration,
  onComplete,
}: CelebrationEffectsConfettiPulseProps) {
  ...
  if (prefersReducedMotion)
    return (
      <div className="pf-celebration" data-animation-id="celebration-effects__confetti-pulse" />
    )
...
export const CelebrationEffectsConfettiPulse = memo(CelebrationEffectsConfettiPulseComponent)
