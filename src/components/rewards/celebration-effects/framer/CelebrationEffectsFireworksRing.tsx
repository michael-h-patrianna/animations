...
import './CelebrationEffectsFireworksRing.module.css'
...
import {
  ...
  type Shimmer,
  type Sparkle,
} from '@/components/rewards/celebration-effects/SharedFireworksRingModel'
...
function CelebrationEffectsFireworksRingComponent({
  ...
  if (prefersReducedMotion)
    return (
      <div className="pf-celebration" data-animation-id="celebration-effects__fireworks-ring" />
    )
