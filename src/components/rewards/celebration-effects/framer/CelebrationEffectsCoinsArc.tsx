...
import './CelebrationEffectsCoinsArc.module.css'
...
function CelebrationEffectsCoinsArcComponent({
  ...
  if (prefersReducedMotion) {
    return <div className="pf-celebration" data-animation-id="celebration-effects__coins-arc" />
  }

  return (
    <div className="pf-celebration" data-animation-id="celebration-effects__coins-arc">
