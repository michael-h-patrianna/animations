 ...
 *
 * Copy-paste files: this file + CelebrationEffectsFireworksRing.css + ../SharedCelebrationTypes.ts + ../utils.ts + ../shared.css
 * Runtime deps: react
 */
...
import './CelebrationEffectsFireworksRing.css'
...
interface CelebrationEffectsFireworksRingProps extends CelebrationBaseProps {
...
function CelebrationEffectsFireworksRingComponent({
  particleCount = EMBER_COUNT,
  particleImages = [],
  particleMaxWidth = 24,
  particleMaxHeight = 24,
  onComplete,
}: CelebrationEffectsFireworksRingProps) {
  ...
  if (skip) {
    return (
      <div
        ...
        data-animation-id="celebration-effects__fireworks-ring"
      />
    )
  }
...
export const CelebrationEffectsFireworksRing = memo(CelebrationEffectsFireworksRingComponent)
