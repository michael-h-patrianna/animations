 ...
 *
 * Copy-paste files: this file + CelebrationEffectsCoinsArc.css + ../SharedCelebrationTypes.ts + ../SharedFallbackCoin.tsx + ../utils.ts + ../shared.css
 * Runtime deps: react
 */
...
import './CelebrationEffectsCoinsArc.css'

/* ─── Props ─── */

interface CelebrationEffectsCoinsArcProps extends CelebrationBaseProps {
...
function CelebrationEffectsCoinsArcComponent({
  ...
  duration,
  onComplete,
}: CelebrationEffectsCoinsArcProps) {
  ...
  if (skip) {
    return (
      <div
        ...
        data-animation-id="celebration-effects__coins-arc"
      />
    )
  }
...
export const CelebrationEffectsCoinsArc = memo(CelebrationEffectsCoinsArcComponent)
