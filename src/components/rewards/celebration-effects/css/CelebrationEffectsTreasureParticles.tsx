 ...
 *
 * Copy-paste files: this file + CelebrationEffectsTreasureParticles.css + ../SharedCelebrationTypes.ts + ../SharedFallbackCoin.tsx + ../utils.ts + ../shared.css
 * Runtime deps: react
 */
...
import './CelebrationEffectsTreasureParticles.css'

/* ─── Props ─── */

interface CelebrationEffectsTreasureParticlesProps extends CelebrationBaseProps {
 ...
 */
function CelebrationEffectsTreasureParticlesComponent({
  coinImage,
  particleImages = [],
  particleMaxWidth = 24,
  particleMaxHeight = 24,
  onComplete,
}: CelebrationEffectsTreasureParticlesProps) {
  ...
  if (skip) {
    return (
      <div
        ...
        data-animation-id="celebration-effects__treasure-particles"
      />
    )
  }
...
export const CelebrationEffectsTreasureParticles = memo(
  CelebrationEffectsTreasureParticlesComponent
)
