 ...
 *
 * Copy-paste files: this file + CelebrationEffectsConfettiSpiral.css + ../SharedCelebrationTypes.ts + ../utils.ts + ../shared.css
 * Runtime deps: react
 */
...
import './CelebrationEffectsConfettiSpiral.css'
  ...
  if (skip) {
    return (
      <div
        ...
        data-animation-id="celebration-effects__confetti-spiral"
      />
    )
  }
