 ...
 *
 * Copy-paste files: this file + CelebrationEffectsConfettiRain.css + ../SharedCelebrationTypes.ts + ../utils.ts + ../shared.css
 * Runtime deps: react
 */
...
import './CelebrationEffectsConfettiRain.css'

/* ─── Props ─── */

interface CelebrationEffectsConfettiRainProps extends CelebrationBaseProps {
...
function CelebrationEffectsConfettiRainComponent({
  ...
  boundary,
  onComplete,
}: CelebrationEffectsConfettiRainProps) {
  ...
  if (skip) {
    return (
      <div
        ...
        data-animation-id="celebration-effects__confetti-rain"
      />
    )
  }
...
export const CelebrationEffectsConfettiRain = memo(CelebrationEffectsConfettiRainComponent)
