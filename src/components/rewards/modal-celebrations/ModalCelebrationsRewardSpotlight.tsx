      ...
      <div className="pf-celebration__layer">
        ...
        <span 
          ...
          style={{
            ...
            background: 'radial-gradient(circle at 50% 28%, rgba(255, 255, 255, 0.75), rgba(255, 255, 255, 0)), radial-gradient(circle at 50% 100%, rgba(198, 255, 119, 0.28), rgba(198, 255, 119, 0))',
