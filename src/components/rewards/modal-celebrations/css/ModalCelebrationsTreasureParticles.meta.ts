...
export const metadata = {
  ...
  urlSlugFramer: '/modal-celebrations-framer?animation=modal-celebrations__treasure-particles',
  ...
  tier: 4,
  props: [
    { type: 'number', name: 'coinCount', label: 'Coin Count', default: 12, min: 1, max: 40, step: 1 },
    { type: 'number', name: 'gemCount', label: 'Gem Count', default: 12, min: 1, max: 40, step: 1 },
    { type: 'image', name: 'coinImage', label: 'Coin Image' },
    { type: 'number', name: 'duration', label: 'Duration', default: 2000, min: 600, max: 5000, step: 100, unit: 'ms' },
