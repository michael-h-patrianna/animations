...
export const dialogsModalCelebrationsAnimations: AnimationComponentMap = {
  ...
  'modal-celebrations__coins-fountain': ModalCelebrationsCoinsFountain,
  'modal-celebrations__coins-swirl': ModalCelebrationsCoinsSwirl,
  'modal-celebrations__confetti-burst': ModalCelebrationsConfettiBurst,
  'modal-celebrations__confetti-pulse': ModalCelebrationsConfettiPulse,
  'modal-celebrations__confetti-rain': ModalCelebrationsConfettiRain,
  'modal-celebrations__confetti-spiral': ModalCelebrationsConfettiSpiral,
  'modal-celebrations__fireworks-ring': ModalCelebrationsFireworksRing,
  'modal-celebrations__fireworks-triple': ModalCelebrationsFireworksTriple,
  'modal-celebrations__jackpot-celebration': ModalCelebrationsJackpotCelebration,
  'modal-celebrations__reward-spotlight': ModalCelebrationsRewardSpotlight,
