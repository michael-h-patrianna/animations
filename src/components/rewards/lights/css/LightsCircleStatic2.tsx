...
function LightsCircleStatic2({
    ...
    () =>
      Array.from({ length: numBulbs }, (_, i) => {
        ...
        return (
          <div
            key={i}
            className={styles['lights-circle-static-2__bulb-wrapper']}
            style={
              {
          ...
          >
            <div className={styles['lights-circle-static-2__glow']} />
            <div className={styles['lights-circle-static-2__bulb']} />
          </div>
        )
      }),
  ...
  return (
    <div
      className={styles['lights-circle-static-2']}
    ...
    >
      <div className={styles['lights-circle-static-2__container']}>{bulbs}</div>
    </div>
  )
}
