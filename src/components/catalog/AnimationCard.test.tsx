...
describe('AnimationCard', () => {
  ...
  it('shows accordion for long descriptions', async () => {
    const longDescription = 'This is a very long description that will definitely exceed one line when rendered in the card component and should trigger the accordion functionality to appear';
