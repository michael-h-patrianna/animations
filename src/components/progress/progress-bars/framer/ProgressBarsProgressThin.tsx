...
export function ProgressBarsProgressThin() {
  ...
  const fillVariants = {
    ...
    visible: {
      ...
      transition: { duration, times: [0, 0.3, 0.7, 1], ease: [0.25, 0.46, 0.45, 0.94] as const },
    },
  }
  const photonVariants = {
    ...
    visible: {
      opacity: [0, 0, 1, 0.5, 0],
      x: [20, 20, 0, -10, -20],
      transition: { duration, times: [0, 0.2, 0.5, 0.9, 1], ease: easeOut },
    },
  }
  const haloVariants = {
    hidden: { opacity: 0 },
    visible: {
      ...
      transition: { duration, times: [0, 0.3, 0.6, 0.9, 1], ease: easeOut },
    },
  }
  ...
  const flashVariants = {
    ...
    visible: {
      opacity: [0, 1, 0],
      scaleX: [0.8, 1, 1],
      transition: { duration: 0.3, times: [0, 0.3, 1], delay: duration, ease: easeOut },
    },
  }
  return (
    <div
      ...
      >
        ...
        <div className="pf-progress-track" style={{ height: '2px' }}>
          <m.div
            ...
            style={{ transformOrigin: 'left center', position: 'relative', overflow: 'visible' }}
          >
            {/* Photon trail */}
            <m.div
