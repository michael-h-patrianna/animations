...
export const metadata: AnimationMetadata = {
  ...
  tier: 3,
  props: [
    { type: 'number', name: 'duration', label: 'Duration', default: 300, min: 100, max: 2000, step: 50, unit: 'ms' },
    { type: 'number', name: 'stagger', label: 'Stagger', default: 70, min: 0, max: 500, step: 10, unit: 'ms' },
