...
import { ModalContentErrorShakeGentle } from './ModalContentErrorShakeGentle';
import { ModalContentErrorShakeIntent } from './ModalContentErrorShakeIntent';
...
import { ModalContentSuccessBounceEnergetic } from './ModalContentSuccessBounceEnergetic';
import { ModalContentSuccessBounceSoft } from './ModalContentSuccessBounceSoft';
...
export { ModalContentErrorShakeGentle } from './ModalContentErrorShakeGentle';
export { ModalContentErrorShakeIntent } from './ModalContentErrorShakeIntent';
...
export { ModalContentSuccessBounceEnergetic } from './ModalContentSuccessBounceEnergetic';
export { ModalContentSuccessBounceSoft } from './ModalContentSuccessBounceSoft';
...
export const dialogsModalContentAnimations: AnimationComponentMap = {
  ...
  'modal-content__error-shake-gentle': ModalContentErrorShakeGentle,
  'modal-content__error-shake-intent': ModalContentErrorShakeIntent,
  ...
  'modal-content__success-bounce-energetic': ModalContentSuccessBounceEnergetic,
  'modal-content__success-bounce-soft': ModalContentSuccessBounceSoft
};
