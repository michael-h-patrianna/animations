...
registerLazyCategory('dialogs', 'Dialog & Modal Animations', [
  { id: 'modal-base-framer', title: 'Base modal animations (Framer)', tech: 'framer', baseGroupId: 'modal-base', animationIds: [], metadata: modalBaseMeta },
  { id: 'modal-base-css', title: 'Base modal animations (CSS)', tech: 'css', baseGroupId: 'modal-base', animationIds: [], metadata: modalBaseMeta },
  { id: 'modal-content-framer', title: 'Modal content animations (Framer)', tech: 'framer', baseGroupId: 'modal-content', animationIds: [], metadata: modalContentMeta },
  { id: 'modal-content-css', title: 'Modal content animations (CSS)', tech: 'css', baseGroupId: 'modal-content', animationIds: [], metadata: modalContentMeta },
  { id: 'modal-dismiss-framer', title: 'Modal dismiss animations (Framer)', tech: 'framer', baseGroupId: 'modal-dismiss', animationIds: [], metadata: modalDismissMeta },
  { id: 'modal-dismiss-css', title: 'Modal dismiss animations (CSS)', tech: 'css', baseGroupId: 'modal-dismiss', animationIds: [], metadata: modalDismissMeta },
  { id: 'modal-open-framer', title: 'Modal open animations (Framer)', tech: 'framer', baseGroupId: 'modal-open', animationIds: [], metadata: modalOpenMeta },
  { id: 'modal-open-css', title: 'Modal open animations (CSS)', tech: 'css', baseGroupId: 'modal-open', animationIds: [], metadata: modalOpenMeta },
  { id: 'modal-orchestration-framer', title: 'Modal orchestration animations (Framer)', tech: 'framer', baseGroupId: 'modal-orchestration', animationIds: [], metadata: modalOrchestrationMeta },
  { id: 'modal-orchestration-css', title: 'Modal orchestration animations (CSS)', tech: 'css', baseGroupId: 'modal-orchestration', animationIds: [], metadata: modalOrchestrationMeta },
])
