...
export const metadata: AnimationMetadata = {
  ...
  urlSlugFramer: '/modal-base-framer?animation=modal-base__slide-down-soft',
  ...
  props: [
    ...
    { type: 'number', name: 'distance', label: 'Distance', default: 60, min: 10, max: 200, step: 5, unit: 'px' },
