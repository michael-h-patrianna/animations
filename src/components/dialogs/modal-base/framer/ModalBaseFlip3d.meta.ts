...
export const metadata: AnimationMetadata = {
  ...
  tier: 2,
  props: [
    { type: 'number', name: 'duration', label: 'Duration', default: 800, min: 100, max: 2000, step: 50, unit: 'ms' },
    { type: 'number', name: 'perspective', label: 'Perspective', default: 1200, min: 200, max: 3000, step: 50, unit: 'px' },
    { type: 'string', name: 'className', label: 'CSS Class', default: '', description: 'Additional CSS class name for the content wrapper.' },
