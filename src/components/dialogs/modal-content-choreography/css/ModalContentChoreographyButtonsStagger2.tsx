 ...
 *
 * Copy-paste files: this file + ModalContentChoreographyButtonsStagger2.module.css + ../shared.css + ../SharedTypes.ts
 * Runtime deps: react
 */
...
import styles from './ModalContentChoreographyButtonsStagger2.module.css'

const DEFAULT_DURATION = 300
const DEFAULT_STAGGER = 70

function ModalContentChoreographyButtonsStagger2Component({
  children,
  ...
  if (items.length > 0) {
    return (
      <div
        ...
        data-animation-id="modal-content-choreography__buttons-stagger-2"
        style={style}
      >
...
export const ModalContentChoreographyButtonsStagger2 = memo(
  ModalContentChoreographyButtonsStagger2Component
)
