 ...
 *
 * Copy-paste files: this file + ModalContentChoreographyFormFieldGradient.module.css + ../shared.css + ../SharedTypes.ts
 * Runtime deps: react
 */
...
import styles from './ModalContentChoreographyFormFieldGradient.module.css'

const DEFAULT_DURATION = 500
const DEFAULT_STAGGER = 120
const DEFAULT_COUNT = 3

function ModalContentChoreographyFormFieldGradientComponent({
  children,
  ...
  if (items.length > 0) {
    return (
      <div
        ...
        data-animation-id="modal-content-choreography__form-field-gradient"
        style={style}
      >
...
export const ModalContentChoreographyFormFieldGradient = memo(
  ModalContentChoreographyFormFieldGradientComponent
)
