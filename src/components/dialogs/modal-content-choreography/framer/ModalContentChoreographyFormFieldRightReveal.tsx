 ...
 *
 * @example
 * <ModalContentChoreographyFormFieldRightReveal stagger={90} distance={40}>
 *   <div><label>Name</label><input /></div>
 *   <div><label>Email</label><input /></div>
 * </ModalContentChoreographyFormFieldRightReveal>
 */
...
import './ModalContentChoreographyFormFieldRightReveal.module.css'
