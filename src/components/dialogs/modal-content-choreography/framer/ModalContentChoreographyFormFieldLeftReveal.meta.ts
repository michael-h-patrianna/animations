...
export const metadata: AnimationMetadata = {
  id: 'modal-content-choreography__form-field-left-reveal',
  urlSlugFramer:
    '/modal-content-choreography-framer?animation=modal-content-choreography__form-field-left-reveal',
  urlSlugCss:
    '/modal-content-choreography-css?animation=modal-content-choreography__form-field-left-reveal',
