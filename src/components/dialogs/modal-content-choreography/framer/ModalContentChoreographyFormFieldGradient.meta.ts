...
export const metadata: AnimationMetadata = {
  id: 'modal-content-choreography__form-field-gradient',
  urlSlugFramer:
    '/modal-content-choreography-framer?animation=modal-content-choreography__form-field-gradient',
  urlSlugCss:
    '/modal-content-choreography-css?animation=modal-content-choreography__form-field-gradient',
