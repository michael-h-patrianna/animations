...
export const metadata: AnimationMetadata = {
  id: 'modal-content-choreography__buttons-stagger-3',
  urlSlugFramer:
    '/modal-content-choreography-framer?animation=modal-content-choreography__buttons-stagger-3',
  urlSlugCss:
    '/modal-content-choreography-css?animation=modal-content-choreography__buttons-stagger-3',
