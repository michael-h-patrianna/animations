...
export const metadata: AnimationMetadata = {
  id: 'modal-content-choreography__list-soft-stagger',
  urlSlugFramer:
    '/modal-content-choreography-framer?animation=modal-content-choreography__list-soft-stagger',
  urlSlugCss:
    '/modal-content-choreography-css?animation=modal-content-choreography__list-soft-stagger',
