...
export const metadata = {
  id: 'tile-animations__selection-grid',
  urlSlugFramer: '/tile-animations-framer?animation=tile-animations__selection-grid',
  urlSlugCss: '/tile-animations-css?animation=tile-animations__selection-grid',
