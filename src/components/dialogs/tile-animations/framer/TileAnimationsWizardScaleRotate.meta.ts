...
export const metadata = {
  id: 'tile-animations__wizard-scale-rotate',
  urlSlugFramer: '/tile-animations-framer?animation=tile-animations__wizard-scale-rotate',
  urlSlugCss: '/tile-animations-css?animation=tile-animations__wizard-scale-rotate',
