...
export const metadata = {
  id: 'tile-animations__flip-reveal',
  urlSlugFramer: '/tile-animations-framer?animation=tile-animations__flip-reveal',
  urlSlugCss: '/tile-animations-css?animation=tile-animations__flip-reveal',
  ...
  props: [
    ...
    },
    {
      ...
      label: 'Items',
      disabled: true,
      disabledReason: 'Array of {front, back} objects — configure in code',
    },
  ],
