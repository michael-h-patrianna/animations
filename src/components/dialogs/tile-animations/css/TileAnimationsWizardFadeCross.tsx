 ...
 *
 * Copy-paste files: this file + TileAnimationsWizardFadeCross.module.css
 * Runtime deps: react
 *
 * @example
 * <TileAnimationsWizardFadeCross stagger={260}>
 *   <StepPanel>...</StepPanel>
 *   <StepPanel>...</StepPanel>
 * </TileAnimationsWizardFadeCross>
 */

import { memo } from 'react'
import type { ReactNode } from 'react'
import styles from './TileAnimationsWizardFadeCross.module.css'
import { DemoCard } from '@/components/demo-blocks'

const DEFAULT_COUNT = 3

interface TileAnimationsWizardFadeCrossProps {
...
function TileAnimationsWizardFadeCrossComponent({
  children,
  stagger = 260,
  duration = 260,
  distance = 16,
}: TileAnimationsWizardFadeCrossProps) {
  ...
  return (
    <div
      ...
      data-animation-id="tile-animations__wizard-fade-cross"
    >
...
export const TileAnimationsWizardFadeCross = memo(TileAnimationsWizardFadeCrossComponent)
