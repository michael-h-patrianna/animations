...
export const metadata = {
  id: 'tile-animations__tab-morph',
  urlSlugFramer: '/tile-animations-framer?animation=tile-animations__tab-morph',
  urlSlugCss: '/tile-animations-css?animation=tile-animations__tab-morph',
