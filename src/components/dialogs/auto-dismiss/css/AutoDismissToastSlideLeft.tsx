 ...
 * Runtime deps: react
 *
 * Usage: <AutoDismissToastSlideLeft duration={5000} onDismiss={remove}><YourToast /></AutoDismissToastSlideLeft>
 */
...
function AutoDismissToastSlideLeftComponent({
  children,
  ...
  return (
    <div
      data-animation-id="auto-dismiss__toast-slide-left"
...
export const AutoDismissToastSlideLeft = memo(AutoDismissToastSlideLeftComponent)
