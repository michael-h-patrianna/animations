...
export const metadata: AnimationMetadata = {
  id: 'auto-dismiss__toast-drop',
  urlSlugFramer: '/auto-dismiss-framer?animation=auto-dismiss__toast-drop',
  urlSlugCss: '/auto-dismiss-css?animation=auto-dismiss__toast-drop',
