...
export const metadata: AnimationMetadata = {
  id: 'auto-dismiss__toast-slide-right',
  urlSlugFramer: '/auto-dismiss-framer?animation=auto-dismiss__toast-slide-right',
  urlSlugCss: '/auto-dismiss-css?animation=auto-dismiss__toast-slide-right',
