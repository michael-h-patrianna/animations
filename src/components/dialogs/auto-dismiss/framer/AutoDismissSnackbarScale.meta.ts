...
export const metadata: AnimationMetadata = {
  id: 'auto-dismiss__snackbar-scale',
  urlSlugFramer: '/auto-dismiss-framer?animation=auto-dismiss__snackbar-scale',
  urlSlugCss: '/auto-dismiss-css?animation=auto-dismiss__snackbar-scale',
