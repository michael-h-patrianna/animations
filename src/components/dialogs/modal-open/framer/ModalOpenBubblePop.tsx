          ...
          <div className="pf-mo-stage">
            <m.div
              ...
              initial={reduced
                ...
                : { x: traj.x[0], y: traj.y[0], scale: traj.scale[0], scaleX: traj.scaleX[0], scaleY: traj.scaleY[0], skewX: traj.skewX[0], opacity: traj.opacity[0] }
              }
              animate={reduced
                ? { scale: s.isClosing ? 0.85 : 1, opacity: s.isClosing ? 0 : 1 }
                : { x: traj.x, y: traj.y, scale: traj.scale, scaleX: traj.scaleX, scaleY: traj.scaleY, skewX: traj.skewX, opacity: traj.opacity }
              }
