...
export const metadata: AnimationMetadata = {
  ...
  title: 'Jello',
  description:
    'Wobble deformation with ripple-through effect and bounce for gelatinous motion. Wraps any element. Configurable duration.',
  tier: 1,
  props: [
    { type: 'number', name: 'duration', label: 'Duration', default: 1000, min: 100, max: 5000, step: 50, unit: 'ms' },
