...
export const metadata: AnimationMetadata = {
  ...
  tier: 1,
  props: [
    { type: 'number', name: 'duration', label: 'Duration', default: 2000, min: 500, max: 8000, step: 100, unit: 'ms' },
    { type: 'number', name: 'pulseScale', label: 'Pulse Scale', default: 1.08, min: 1.01, max: 1.3, step: 0.01 },
    { type: 'number', name: 'bobDistance', label: 'Bob Distance', default: 4, min: 0, max: 20, step: 1, unit: 'px' },
