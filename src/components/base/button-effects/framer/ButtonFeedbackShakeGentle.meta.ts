...
export const metadata: AnimationMetadata = {
  ...
  tier: 1,
  props: [
    { type: 'number', name: 'duration', label: 'Duration', default: 400, min: 100, max: 2000, step: 50, unit: 'ms' },
    { type: 'string', name: 'trigger', label: 'Trigger', disabled: true, disabledReason: 'Pass boolean via trigger prop for programmatic activation' },
