 ...
 * and load eagerly. Every other preview font is injected as a <style> block
 * the first time it is selected — one network request per font file, zero
 * requests for fonts the user never picks.
 *
