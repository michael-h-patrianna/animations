...
describe('realtime-data timer cleanup', () => {
  it('cleans up CSS leaderboard timers on unmount', () => {
    assertNoLeakedTimersAfterUnmount(CssRealtimeDataLeaderboardShift, {
      advanceBeforeUnmountMs: 800,
    })
  })

  it('cleans up Framer leaderboard timers on unmount', () => {
    assertNoLeakedTimersAfterUnmount(FramerRealtimeDataLeaderboardShift, {
      advanceBeforeUnmountMs: 800,
    })
  })

  it('cleans up CSS live-score timers after nested scheduling', () => {
    assertNoLeakedTimersAfterUnmount(CssRealtimeDataLiveScoreUpdate, {
      advanceBeforeUnmountMs: 2100,
    })
  })

  it('cleans up Framer live-score timers after nested scheduling', () => {
    assertNoLeakedTimersAfterUnmount(FramerRealtimeDataLiveScoreUpdate, {
      advanceBeforeUnmountMs: 2300,
    })
  })

  it('cleans up CSS stacked-realtime timers after nested scheduling', () => {
    assertNoLeakedTimersAfterUnmount(CssRealtimeDataStackedRealtime, {
      advanceBeforeUnmountMs: 1600,
    })
  })

  it('cleans up Framer stacked-realtime timers after nested scheduling', () => {
    assertNoLeakedTimersAfterUnmount(FramerRealtimeDataStackedRealtime, {
      advanceBeforeUnmountMs: 1600,
    })
  })
})
