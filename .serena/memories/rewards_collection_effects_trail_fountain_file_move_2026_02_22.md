...
- Coin Trail and Coin Fountain were registered under collection-effects but their implementation files/metadata still lived in modal-celebrations, and registry keys used modal-celebrations\_\_ prefix.
...
- Updated export names and data-animation-id to collection-effects**coin-trail and collection-effects**coins-fountain.
...
- Structural audits pass:
  ...
  - no cross-group ../ imports in src/components/_/_/index.ts
- Tests pass:
