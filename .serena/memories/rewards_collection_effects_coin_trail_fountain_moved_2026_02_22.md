...
- src/components/rewards/collection-effects/index.ts
  ...
  - Added groupExport entries for ids modal-celebrations**coin-trail and modal-celebrations**coins-fountain in both framer and css maps.
...
- npm test -- src/**tests**/registryConsistency.test.ts (pass)
- npm run build (pass)
