...
| `npm run generate:groups` | Regenerate group `index.ts` files from codegen manifest                                     |
| `npm run validate`        | Full quality gate (codegen-check + type-check + lint + format + test + build + bundle-size) |
